...
namespace Assets.Scripts.Model
{
    public class Ataque : Acao
    {
        ...
        public AudioSource damageCriticalAudio;
        public AudioSource damageMissedAudio;
        ...
        // METODO PRINCIPAL EFETUAR ATAQUE
        public override void EfetuaAcao()
        {
            ...
            else
            {
                if(dano==0)
                {
                    ...
                    damageMissedAudio.Play();
                }
                else
                {
                    if (/*for critico*/) {
                        this.GetAlvo().hpAtual = this.GetAlvo().hpAtual - dano;
                        damageCriticalAudio.Play();
                    } else {
                        this.GetAlvo().hpAtual = this.GetAlvo().hpAtual - dano;
                        damageAudio.Play();
                    }
